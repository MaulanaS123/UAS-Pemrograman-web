...
<head>
	...
	<title>Masjid Assallam</title>
	<link rel="icon" href="dist/img/masjid_1.png">
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="http://localhost/kas_masjid/" class="brand-link">
				<img src="dist/img/masjid_1.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text font-weight-light"> Masjid Assallam</span>
			</a>
